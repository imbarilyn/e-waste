...
import {type Product, useAggregatorAuthStore} from "@/stores";
...
$(document).ready(function() {
  ...
  material_table_el.value?.DataTable({
    columns: columns,
    ajax: {
      url: `${BASE_URL}/aggregator/get-products/${aggregatorAuthStore.getAggregatorInfo()?.userId}/?limit=5&offset=5&all_products=1`,
      dataSrc: (json) => {
